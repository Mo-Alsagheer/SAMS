...
function LastSection() {
  return (
    <div className="px-6 py-12"> 
      <section className="relative max-w-6xl mx-auto overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 py-16 px-8 shadow-2xl shadow-blue-900/20">

  ...
  return (
    <div className="">
      <div className="space-y-5">
        ...
        {/* AI Review Breakdown or Error */}
        {app.aiScore && app.aiScore.error && (
          <Card>
            <CardHeader>
              <CardTitle>AI Review Error</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-destructive">{app.aiScore.error}</p>
            </CardContent>
          </Card>
        )}
                  ...
                  Object.entries(app.aiScore.per_criterion_scores).map(
                    ([key, v]) => {
                      ...
                      const justification =
                        ...
                        app.aiScore.justification?.find(
                          (j) => j.description === key,
                        )?.justification;

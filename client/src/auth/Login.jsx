  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-slate-50 pt-20">
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[2rem] overflow-hidden shadow-[0_0_50px_-12px_rgba(37,99,235,0.25)] border border-slate-100 min-h-[500px]">
          ...
          <div className="relative hidden lg:flex flex-col items-center justify-center bg-gradient-to-br from-blue-600 to-blue-800 p-8 text-white">
            <div className="relative z-10 text-center space-y-4">
              ...
              <p className="text-blue-100/80 font-medium text-sm max-w-[220px] mx-auto">
          ...
          <div className="flex items-center justify-center p-8 lg:p-12">
            <div className="w-full max-w-[360px] space-y-6">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <Link to="/forgot-password" style={{ display: 'block', textAlign: 'right', fontSize: '12px' }} className="text-blue-600 hover:underline font-medium">Forgot password?</Link>

                <Button className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-base" type="submit">
                  Enter Platform
                </Button>
              </form>
            </div>

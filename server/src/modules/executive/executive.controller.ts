...
export class ExecutiveController {
  ...
  @ApiQuery({ name: 'committeeId', required: false, description: 'ULID of the committee (omit to fetch EXECUTIVE applications)', example: '01HRGZ...' })
  @ApiQuery({ name: 'status', required: false, description: 'Filter by application status', example: 'PENDING' })
  @ApiResponse({ status: 200, description: 'List of applications for the specified committee or role.' })
  getApplications(
  ...
  @ApiParam({ name: 'id', description: 'ULID of the application', example: '01HRGZ...' })
  @ApiResponse({ status: 201, description: 'Application accepted for Phase 1.' })
  ...
  @ApiParam({ name: 'id', description: 'ULID of the application', example: '01HRGZ...' })
  @ApiResponse({ status: 201, description: 'Application rejected during Phase 1.' })
  @ApiResponse({ status: 404, description: 'Application not found.' })
  ...
  @ApiBody({
    schema: {
      type: 'object',
      properties: {
        date: { type: 'string', format: 'date-time', example: '2023-11-15T10:00:00Z' },
  ...
  @ApiParam({ name: 'id', description: 'ULID of the application', example: '01HRGZ...' })
  @ApiResponse({ status: 201, description: 'Application accepted for Phase 2.' })
  @ApiResponse({ status: 404, description: 'Application not found.' })
  ...
  @ApiParam({ name: 'id', description: 'ULID of the application', example: '01HRGZ...' })
  @ApiResponse({ status: 201, description: 'Application rejected during Phase 2.' })
  @ApiResponse({ status: 404, description: 'Application not found.' })

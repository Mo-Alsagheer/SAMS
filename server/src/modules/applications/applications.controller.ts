...
export class ApplicationsController {
  ...
  @ApiResponse({ status: 400, description: 'Recruitment is not open for this committee.' })
  @ApiResponse({ status: 409, description: 'An application with this email has already been submitted.' })

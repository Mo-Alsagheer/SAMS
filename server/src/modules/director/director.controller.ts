...
export class DirectorController {
  ...
  @ApiQuery({ name: 'committeeId', required: true, description: 'ULID of the committee', example: '01HRGZ...' })
  @ApiQuery({ name: 'status', required: false, description: 'Filter by application status', example: 'PENDING' })
  @ApiResponse({ status: 200, description: 'List of applications for the specified committee.' })
  getApplications(
